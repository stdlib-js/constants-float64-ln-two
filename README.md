...
```javascript
LN2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-ln-two@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-ln-two@v0.2.2-umd/browser.js"></script>
```
